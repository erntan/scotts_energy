...
# Analysis
## Electricity Usage 
Now we have properly formatted the data that is needed to explore electricity usage. Let us store the relevant data in the variable `elec_usage`.
```{r}
elec_usage <- d[c(
        "site_name", "department",
        "electricity_usage", "peak_electric_demand",
        "building_type", "building_area", "energy_use_intensity", "latitude",
        "longitude"
)]
```
